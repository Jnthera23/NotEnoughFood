...
<head>
	...
	<link rel="stylesheet" href="css/style.css" /> <!-- css.com stylesheet -->
	<link rel="stylesheet" href="css/animate.css" /> <!-- animate.com stylesheet -->
	<link href="http://fonts.googleapis.com/css?family=Raleway:400,300,500,600,700,800" rel="stylesheet"> <!-- Google api font styles -->
	<link rel="shortcut icon" href="images/favicon.ico" /> <!-- image favicon for url -->
	
	
	
</head> <!-- facebook oAuth / Ayo-->
<body class="home">
	<!--header-->
	<div id="fb-root"></div>
...
function getData(idtosend){
 ...
 ?>						
	...
	<script> <!-- configuration of animations -->
